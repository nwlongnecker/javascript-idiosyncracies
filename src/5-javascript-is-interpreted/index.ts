 ...
 * Instead, it starts from an entrypoint provided at application startup, and discovers imports as it goes.
 * If a file is never imported, that code won't be executed.
 * This makes it very easy to trace all the files that will be included in the application and what's including them.
 * 
 * For example, the file in this folder named "fileNotImported" will not be executed
 * because it is not imported by this entrypoint file.
 */
